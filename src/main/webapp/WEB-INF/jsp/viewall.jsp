...
<table border="1" width="50%">
	 ...
	 <tr>
	  ...
	  <td><a href='/edit/${foodproducts.productId}'><input name="frontcrud" type="submit" value="Edit" /></a> </td>
		    <td><a href='/delete/${foodproducts.productId}'><input type="submit" name="frontcrud" value="Delete"/></a></td>
